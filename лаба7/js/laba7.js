window.onload = function(){
  ...
  var stars_geometry_1 = new THREE.Geometry();
  var stars_material_1 = new THREE.PointsMaterial({
    color: 0xffffff,
    opacity: true,
    size: 1,
    sizeAttenuation: false
  ...
  for (var i = 0; i < 40000; i++) {
    ...
    stars_geometry_1.vertices.push(vertex);
  }
  var stars_1 = new THREE.Points(stars_geometry_1, stars_material_1);
  stars_1.scale.set(200, 200, 200);
  scene.add(stars_1);
  var stars_geometry_2 = new THREE.Geometry();
  var stars_material_2 = new THREE.PointsMaterial({
    color: 0x8c8cff,
    opacity: true,
    size: 1,
    sizeAttenuation: false
  ...
  for (var i = 0; i < 10000; i++) {
    ...
    vertex.z = Math.random()*2-1;
    vertex.multiplyScalar(2000);
    stars_geometry_2.vertices.push(vertex);
  }
  var stars_2 = new THREE.Points(stars_geometry_2, stars_material_2);
  stars_2.scale.set(200, 200, 200);
  scene.add(stars_2);
  var t = 0;
