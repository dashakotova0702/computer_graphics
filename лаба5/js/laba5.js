window.onload = function(){
  ...
  var ring_saturn_material = new THREE.PointsMaterial({
    color: 0x3a3a3a,
    size: 1,
  ...
  var ring = new THREE.Points(ring_saturn_geometry, ring_saturn_material);
  ...
  var rendering = function() {
    ...
    camera.position.x = Math.sin(t*0.08)*14000;
    camera.position.y = 500;
    camera.position.z = Math.cos(t*0.08)*14000;
